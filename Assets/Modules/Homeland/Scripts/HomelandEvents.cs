...
namespace Niantic.ARVoyage.Homeland
{
    ...
    public class HomelandEvents : DemoEvents
    {
        ...
        public void GoToSnowballToss()
        {
            // SceneManager.LoadScene("Modules/SnowballToss/SnowballToss");
            if (SceneLookup.TryGet<Fader>(out Fader fader))
            {
                fader.FadeSceneOut(Color.white, onComplete: () => SceneManager.LoadScene("Modules/SnowballToss/SnowballToss"));
            }
        }
        public void GoToPitch()
        {
            if (SceneLookup.TryGet<Fader>(out Fader fader))
            {
                fader.FadeSceneOut(Color.white, onComplete: () => SceneManager.LoadScene("Modules/SnowballToss/Capstone/Scene/Pitch type Archive"));
            }
        }
        public void GoToQuiz()
        {
            if (SceneLookup.TryGet<Fader>(out Fader fader))
            {
                fader.FadeSceneOut(Color.white, onComplete: () => SceneManager.LoadScene("Modules/SnowballToss/Capstone/Scene/Quiz"));
            }
        }

...
namespace Niantic.ARVoyage.SnowballToss
{
    ...
    public class Snowring : MonoBehaviour
    {
        ...
        public static float minLifetimeSecs = 20f;
        public static float maxLifetimeSecs = 30f;
        ...
        // lcw
        private float minPlacementDist = 2.5f;
        private float maxPlacementDist = 2.75f;
        private float minXAxisAnge = -5;
        private float maxXAxisAngle = 5f;
        ...
        private const int numPlacementSectors = 360 / 10;
        private const float degreesPerSector = 360f / (float)numPlacementSectors;
